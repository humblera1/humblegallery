...
$imagePath = Yii::$app->urlManager->createAbsoluteUrl('/images/reset-password-mail.png');
                                        ...
                                        <table width="100%">
                                            ...
                                            <tr>
                                                <td align="center" style="padding: 20px 30px 40px 30px;">
                                                    <img src="<?= $imagePath ?>" alt="Reset Button Image" style="max-height: 210px; width: auto;">
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td align="center" style="padding-bottom: 60px;">
                                                    <a href="<?= Html::encode($resetLink) ?>" style="background-color: #C98412; color: #ffffff; padding: 10px 24px; text-decoration: none; font-weight: bold; border-radius: 100px; display: inline-block;">
                                                        Сбросить
                                                    </a>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding-bottom: 24px; font-size: 14px; color: #7D6F61;">
                                                    ...
                                                    <a href="<?= Html::encode($resetLink) ?>" style="color: #C98412; text-decoration: none;">
